...
export default async function ProductsPage({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-4 sm:py-10 lg:px-6">
      <ScrollReveal animation="fade-up">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-ink">All products</h1>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Link
              ...
              className={`rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium transition ${
                !category
                  ? "bg-primary text-header shadow"
                  : "bg-white text-ink shadow-sm hover:shadow-card transition-shadow"
              }`}
            >
              All
            </Link>
